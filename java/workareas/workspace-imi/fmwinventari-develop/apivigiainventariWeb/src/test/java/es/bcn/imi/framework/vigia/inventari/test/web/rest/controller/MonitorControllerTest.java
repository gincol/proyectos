...
@TestPropertySource(locations = {"classpath:app/config/application.properties", "classpath:app/config/application.properties.LOCAL" })
@WebAppConfiguration
public class MonitorControllerTest {
	...
	public void liveness() throws Exception {
		mockMvc.perform(get("/monitor/liveness"))
			.andDo(print())
	...
	public void uptime() throws Exception {
		mockMvc.perform(get("/monitor/uptime"))
			.andDo(print())
			.andExpect(status().isOk());
	}
