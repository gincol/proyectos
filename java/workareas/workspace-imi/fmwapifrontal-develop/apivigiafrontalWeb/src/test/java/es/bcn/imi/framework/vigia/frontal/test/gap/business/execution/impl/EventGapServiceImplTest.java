...
import es.bcn.imi.framework.vigia.frontal.gap.execution.services.impl.EventGapServiceImpl;
...
@WebAppConfiguration
public class EventGapServiceImplTest {
	...
	@InjectMocks
	private EventGapServiceImpl service;
