...
import es.bcn.imi.framework.vigia.frontal.inventary.services.impl.MaterialResourceNoVehicleServiceImpl;
...
@WebAppConfiguration
public class RRMMNoVehicleServiceImplTest {
	
	@Mock
	private MyBatisTemplate myBatisTemplate;
	
	@InjectMocks
	private MaterialResourceNoVehicleServiceImpl service;
	...
	public void caseOk() throws  ImiException {
		service.getMaterialResourcesNoVehicleByCode(new HashMap<String,Object>());
	}
}
