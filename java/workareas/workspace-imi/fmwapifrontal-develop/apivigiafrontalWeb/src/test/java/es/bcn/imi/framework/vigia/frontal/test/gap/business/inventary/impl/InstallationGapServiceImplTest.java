...
import es.bcn.imi.framework.vigia.frontal.gap.inventary.services.impl.InstallationGapServiceImpl;
...
@WebAppConfiguration
public class InstallationGapServiceImplTest {

	@Mock
	private MyBatisTemplateGap myBatisTemplateGap;
	
	@InjectMocks
	private InstallationGapServiceImpl service;
	...
	public void caseOk() throws ImiException {
		service.getInstallationsGap(new HashMap<String,Object>());
	}
}
