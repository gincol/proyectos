...
import es.bcn.imi.framework.vigia.frontal.gap.inventary.services.impl.CommerceGapServiceImpl;
...
@WebAppConfiguration
public class CommerceGapServiceImplTest {
	...
	@InjectMocks
	private CommerceGapServiceImpl service;
	...
	public void caseOk() throws ImiException {
		service.getCommercesGap(new HashMap<String,Object>());
	}
