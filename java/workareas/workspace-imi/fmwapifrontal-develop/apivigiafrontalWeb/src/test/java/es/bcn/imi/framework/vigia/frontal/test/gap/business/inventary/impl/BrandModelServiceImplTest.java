...
import es.bcn.imi.framework.vigia.frontal.gap.inventary.services.impl.BrandModelGapServiceImpl;
...
@WebAppConfiguration
public class BrandModelServiceImplTest {
	...
	@InjectMocks
	private BrandModelGapServiceImpl service;
