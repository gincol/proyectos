...
import es.bcn.imi.framework.vigia.frontal.gap.inventary.services.impl.MaterialResourceGapServiceImpl;
...
@WebAppConfiguration
public class MaterialResourceGapServiceImplTest {
	
	@Mock
	private MyBatisTemplateGap myBatisTemplateGap;
	
	@InjectMocks
	private MaterialResourceGapServiceImpl service;
	...
	public void caseOk() throws ImiException {
		service.getMaterialResourcesGap("");
	}
