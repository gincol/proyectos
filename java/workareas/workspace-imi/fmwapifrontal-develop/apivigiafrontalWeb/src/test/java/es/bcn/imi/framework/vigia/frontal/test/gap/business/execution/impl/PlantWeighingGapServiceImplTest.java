...
import es.bcn.imi.framework.vigia.frontal.gap.execution.services.impl.PlantWeighingGapServiceImpl;
...
@WebAppConfiguration
public class PlantWeighingGapServiceImplTest {
	...
	@InjectMocks
	private PlantWeighingGapServiceImpl service;
