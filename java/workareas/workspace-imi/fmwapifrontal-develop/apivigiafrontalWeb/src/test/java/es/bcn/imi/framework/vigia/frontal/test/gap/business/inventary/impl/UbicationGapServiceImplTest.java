...
import es.bcn.imi.framework.vigia.frontal.gap.inventary.services.impl.UbicationGapServiceImpl;
...
@WebAppConfiguration
public class UbicationGapServiceImplTest {

	@Mock
	private MyBatisTemplateGap myBatisTemplateGap;
	
	@InjectMocks
	private UbicationGapServiceImpl service;
	...
	public void caseOk() throws ImiException {
		service.getUbicationsGap(new HashMap<String,Object>());
	}
	
	@Test
	public void caseOkUbicationsByCodeAndType() throws ImiException {
		service.getUbicationsGapByCodeType("","");
	}
